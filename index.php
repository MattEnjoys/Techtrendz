...
<div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-8 col-lg-6">
        <img src="assets/images/logo-tech-trendz.png"
    ...
    <div class="col-lg-6">
        <h1 class="display-5 fw-bold lh-1 mb-3 text-center">Responsive left-aligned hero with image
        </h1>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
            <a href="actualites.php"
               class="btn btn-primary btn-lg px-4 me-md-2">Voir toutes les actualités</a>
        </div>
    </div>
</div>
